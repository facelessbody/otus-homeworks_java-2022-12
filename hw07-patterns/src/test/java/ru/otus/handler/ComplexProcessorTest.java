...
class ComplexProcessorTest {
    ...
    void handleProcessorsTest() {
        //given
        var message = Message.builder(1L).field7("field7").build();
    ...
    void handleExceptionTest() {
        //given
        var message = Message.builder(1L).field8("field8").build();
    ...
    void notifyTest() {
        //given
        var message = Message.builder(1L).field9("field9").build();
